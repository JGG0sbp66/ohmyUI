...
<template>
  <div>
    ...
    <ComponentDocsSection title="InputText" class="mt-10">
      ...
      <SpecimenPair class="mt-6">
        <SpecimenCase label="可编辑状态" class="mt-4">
          <div class="space-y-5">
        ...
        <SpecimenCase label="静态前缀与字段提示" class="mt-5">
          <div>
            <InputField required>
              <template #label>
                <span class="inline-flex items-center gap-1.5 text-accent">
                  <Link2 aria-hidden="true" class="size-4 shrink-0" />
                  <span>永久连接</span>
                </span>
              </template>
    ...
    <ComponentDocsSection title="InputPassword" class="mt-16">
      ...
      <SpecimenPair class="mt-6">
        <SpecimenCase label="显隐与错误" class="mt-4">
          <div class="space-y-5">
    ...
    <ComponentDocsSection title="InputTextarea" class="mt-16">
      ...
      <SpecimenPair class="mt-6">
        <SpecimenCase label="多行与字数" class="mt-4">
          <div class="space-y-5">
    ...
    <ComponentDocsSection title="InputNumber" class="mt-16">
      ...
      <SpecimenPair class="mt-6">
        <SpecimenCase label="整数、小数与空值" class="mt-4">
          <div class="space-y-5">
        ...
        <SpecimenCase label="错误与受限状态" class="mt-5">
          <div class="space-y-5">
    ...
    <ComponentDocsSection title="InputSearch" class="mt-16">
      ...
      <SpecimenPair class="mt-6">
        <SpecimenCase label="默认宽度与 search 事件" class="mt-4">
          <div class="space-y-5">
      ...
      <ApiTable caption="InputSearch Props and Events" :rows="INPUT_SEARCH_API" />
    </ComponentDocsSection>

    <ComponentDocsSection title="InputField" class="mt-16">
      <template #description>
      ...
      <SpecimenPair class="mt-6">
        <SpecimenCase label="说明与错误关联" class="mt-4">
          <div class="space-y-5">
        ...
        <SpecimenCase label="标签插槽与禁用" class="mt-5">
          <div>
      ...
      <ApiTable caption="InputField Props and Slots" :rows="INPUT_FIELD_PROPS" />
    </ComponentDocsSection>
  </div>
</template>
