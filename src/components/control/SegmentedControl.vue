...
<template>
  ...
  >
    <div
      v-if="indicatorStyle"
      aria-hidden="true"
      class="absolute top-1 bottom-1 left-1 rounded-lg bg-bg-card shadow-sm ring-1 ring-border/50 transition-transform ease-in-out"
    ...
    <button
      ...
      class="relative z-10 flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-lg py-2 text-xs font-medium transition-colors enabled:hover:text-fg disabled:cursor-not-allowed disabled:opacity-50"
